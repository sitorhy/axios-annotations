...
function requireFormData$1 () {
	if (hasRequiredFormData$1) return FormData$2;
	hasRequiredFormData$1 = 1;
	// eslint-disable-next-line strict
	FormData$2 = requireForm_data();
	return FormData$2;
}
...
function requireToFormData () {
	...
	var envFormData = requireFormData$1();
...
function requireBuildURL () {
	 ...
	 */
	buildURL = function buildURL(url, params, options) {
	  /*eslint no-param-reassign:0*/
	  if (!params) {
	    return url;
	  }
...
function requireURLSearchParams () {
	...
	URLSearchParams$1 = url.URLSearchParams;
...
function requireNode$1 () {
	...
	node$1 = {
	  isNode: true,
	  classes: {
	    URLSearchParams: requireURLSearchParams(),
...
function requirePlatform () {
	...
	platform = requireNode$1();
	return platform;
}

var toURLEncodedForm;
var hasRequiredToURLEncodedForm;

function requireToURLEncodedForm () {
	if (hasRequiredToURLEncodedForm) return toURLEncodedForm;
	hasRequiredToURLEncodedForm = 1;

	var utils = requireUtils();
	var toFormData = requireToFormData();
	var platform = requirePlatform();

	toURLEncodedForm = function toURLEncodedForm(data, options) {
...
var formDataToJSON_1;
var hasRequiredFormDataToJSON;

function requireFormDataToJSON () {
	if (hasRequiredFormDataToJSON) return formDataToJSON_1;
	hasRequiredFormDataToJSON = 1;
	...
	formDataToJSON_1 = formDataToJSON;
	return formDataToJSON_1;
}
...
function requireHttp$1 () {
	if (hasRequiredHttp$1) return http;
	hasRequiredHttp$1 = 1;
	http = requireFollowRedirects().http;
	return http;
}
...
var fromDataURI;
var hasRequiredFromDataURI;

function requireFromDataURI () {
	if (hasRequiredFromDataURI) return fromDataURI;
	hasRequiredFromDataURI = 1;
	 ...
	 * @returns {Buffer|Blob}
	 */
	fromDataURI = function fromDataURI(uri, asBlob, options) {
...
function requireHttp () {
	...
	var buildFullPath = requireBuildFullPath();
	var buildURL = requireBuildURL();
	var getProxyForUrl = requireProxyFromEnv().getProxyForUrl;
	var http = require$$3;
	var https = require$$4;
	var httpFollow = requireHttp$1();
	var httpsFollow = requireHttps();
	var url = require$$0$2;
	var zlib = require$$10;
	...
	var CanceledError = requireCanceledError();
	var platform = requirePlatform();
	var fromDataURI = requireFromDataURI();
...
function requireDefaults () {
	...
	var transitionalDefaults = requireTransitional();
	var toFormData = requireToFormData();
	var toURLEncodedForm = requireToURLEncodedForm();
	var platform = requirePlatform();
...
function requireAxios$1 () {
	...
	axios$2.exports = axios;

	// Allow use of default import syntax in TypeScript
	axios$2.exports.default = axios;
...
var Config = /** @class */ (function () {
    function Config(protocol, host, port, prefix, plugins) {
    ...
    Config.forName = function (name) {
        var c = _global_configs.find(function (i) { return i.name === name; });
        if (c) {
            return c.config;
        }
        else {
    ...
    Object.defineProperty(Config.prototype, "axios", {
        get: function () {
            return this._axios;
        },
        set: function (value) {
    ...
    Config.prototype.register = function (name) {
        var _this = this;
        var c = _global_configs.find(function (i) { return i.config === _this; });
        if (c) {
            c.name = name;
        }
        else {
            _global_configs.push({ name: name, config: this });
        }
        return this;
    };
    ...
    Config.prototype.unregister = function () {
        var _this = this;
        var index = _global_configs.findIndex(function (i) { return i.config === _this; });
        if (index >= 0) {
...
function forward(axios, origin, prefix1, prefix2, path, method, query, body, config) {
    var url = "".concat(origin) + normalizePath("/".concat(prefix1, "/").concat(prefix2, "/").concat(path));
    if (query) {
...
var ConfigMapping = {
    requestHeaders: function (rules, args) {
        if (args === void 0) { args = []; }
        var headers = {};
        if (rules) {
            for (var h in rules) {
    ...
    axiosConfig: function (options, args) {
        var config = {};
    ...
    querystring: function (features, rules, data) {
        if (!data) {
            return "";
        }
        if (rules) {
            var encoder = URLSearchParamsParser.decode(data);
            for (var key in data) {
                var value = data[key];
                var rule = rules[key];
                if (rule) {
...
var Service = /** @class */ (function () {
    ...
    Service.prototype.params = function (id, name, config) {
        var _a, _b;
        if (config === void 0) { config = { required: false }; }
        if (!this._params || !this._params[id] || !Object.hasOwnProperty.call(this._params[id], name)) {
            ...
            this._params =
                Object.assign(root, (_a = {},
                    _a[id] = Object.assign(rules, (_b = {},
                        _b[name] = Object.assign(rule, cfg),
                        _b)),
                    _a));
        }
    };
    Service.prototype.headers = function (id, header, value) {
        ...
        Object.assign(root, (_a = {},
            _a[id] = Object.assign(root[id] || {}, (_b = {},
                _b[header] = value,
                _b)),
            _a));
    };
    Service.prototype.for = function (id, registrationName) {
        ...
        Object.assign(this._for, (_a = {},
            _a[id] = registrationName,
            _a));
    };
    ...
    Service.prototype.features = function (id, options) {
        ...
        Object.assign(this._features, (_a = {},
            _a[id] = options,
            _a));
    };
    ...
    Service.prototype.pathVariable = function (path, data) {
        ...
        if (Array.isArray(matchers)) {
            matchers.forEach(function (m) {
                ...
                p = replaceAllStr(p, "{".concat(field, "}"), data[field]);
            });
        }
        return p;
    };
    Service.prototype.createRequestConfig = function (id, path, data, headerArgs, configArgs) {
        if (headerArgs === void 0) { headerArgs = []; }
        if (configArgs === void 0) { configArgs = []; }
        var query = ConfigMapping.querystring(this._features[id], this._params[id], data);
        var body = ConfigMapping.body(this._params[id], data);
        var headers = ConfigMapping.requestHeaders(this._headers[id], headerArgs);
        var config = ConfigMapping.axiosConfig(this._configs[id], configArgs);
    ...
    Service.prototype.request = function (method, path, data, config) {
        if (data === void 0) { data = {}; }
        if (config === void 0) { config = {}; }
        var url = path.indexOf("http") >= 0 ? path : this.config.baseURL + normalizePath("/".concat(this.path || "", "/").concat(path));
    ...
    Service.prototype.requestWith = function (method, path) {
        ...
        var controller = {
            with: function (registration) {
                var c = Config.forName(registration);
                if (c) {
                    _withConfig = c;
                }
                return controller;
            },
            param: function (key, required) {
                var _a;
                if (required === void 0) { required = false; }
                var rule = _params[key] || {};
                Object.assign(_params, (_a = {},
                    _a[key] = Object.assign(rule, { required: required, body: false }),
                    _a));
                return controller;
            },
            abort: function (abortController) {
                Object.assign(_features, {
                    abortController: abortController
                });
                return controller;
            },
            ignoreResidualParams: function (ignore) {
            ...
            body: function (key) {
                ...
                Object.assign(_params, (_a = {},
                    _a[key] = Object.assign(rule, { required: false, body: true }),
                    _a));
                return controller;
            },
            config: function (cfg) {
            ...
            send: function (data) {
                if (data === void 0) { data = {}; }
                var query = ConfigMapping.querystring(_features, _params, data);
                var body = ConfigMapping.body(_params, data);
                var headers = ConfigMapping.requestHeaders(_headers, [data]);
                var config = ConfigMapping.axiosConfig(_configs, [data]);
                var abortController = _features.abortController;
                Object.assign(config, {
                    headers: Object.assign(headers, config.headers || null)
                });
                if (abortController) {
                ...
                if (_withConfig) {
                    return forward(_withConfig.axios, _withConfig.origin, _withConfig.prefix, _this.path, path, method, query, body, config);
                }
                else {
                    var p = "".concat(_this.pathVariable(path || "", data)).concat(query ? ((path.lastIndexOf("?") >= 0 ? "&" : "?") + query) : "");
                    return _this.request(method, p, body, config);
                }
            }
        };
        return controller;
    ...
    return function (_target, method, descriptor) {
        if (descriptor) {
            ...
            descriptor.value = function () {
                ...
                return fn_1.apply(this, arguments);
            };
        }
    };
}
    ...
    return function (target, name, descriptor) {
        if (!descriptor) {
            ...
            descriptor.value = function () {
                ...
                // 根据名称获取配置
                var withConfig = Config.forName(withConfigName || "");
                if (data && data.then && typeof data.then === "function") {
                    return new Promise(function (resolve, reject) {
                        data.then(function (d) {
                            ...
                            if (withConfig) {
                                forward(withConfig.axios, withConfig.origin, withConfig.prefix, _this.path, path, method || "GET", query, body, config).then(resolve).catch(reject);
                            }
                            else {
                                _this.request(method || "GET", p, body, config).then(resolve).catch(reject);
                            }
                        });
                    });
                }
                else {
                    var _a = this.createRequestConfig(name, this.pathVariable(path || "", data), data, args, args), p = _a.path, body = _a.body, config = _a.config, query = _a.query;
                    if (withConfig) {
                        return forward(withConfig.axios, withConfig.origin, withConfig.prefix, this.path, path, method || "GET", query, body, config);
                    }
                    else {
                        return this.request(method || "GET", p, body, config);
                    }
                }
            };
        }
