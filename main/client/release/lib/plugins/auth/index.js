...
var PendingQueue = /** @class */ (function () {
     ...
     */
    function PendingQueue(authorizer) {
        this._queue = [];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, sleep(random(3000, 5000))];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3: return [4 /*yield*/, this._authorizer.getSession()];
                    case 4:
                        session = _a.sent();
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this._axios.request(error.config)];
    ...
    PendingQueue.prototype.push = function (error) {
        ...
        return new Promise(function (resolve, reject) {
            _this._queue.push({ error: error, resolve: resolve, reject: reject });
        });
    };
...
function AuthorizationPlugin(authorizer) {
    return function (config) {
        var unauthorized = false;
        var expiredSession = null;
        var queue = new PendingQueue(authorizer);
        config.axios.interceptors.response.use(function (i) {
            if (expiredSession) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                var response, session, _a, _b, e2_1, e4_1;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            response = e.response;
                            if (!!authorizer.checkResponse(response)) return [3 /*break*/, 24];
                            if (!!unauthorized) return [3 /*break*/, 21];
                            unauthorized = true;
                            return [4 /*yield*/, authorizer.getSession()];
                        case 1:
                            session = _c.sent();
                            if (!authorizer.sessionHistory.isDeprecated(session)) return [3 /*break*/, 6];
                            _c.label = 2;
                        case 2:
                            _c.trys.push([2, 4, 5, 6]);
                            return [4 /*yield*/, authorizer.onAuthorizedDenied(e)];
                        case 3:
                            _c.sent();
                        ...
                        case 6:
                            ...
                            if (!!authorizer.checkSession(e.config, session)) return [3 /*break*/, 16];
                            _c.label = 7;
                        case 7:
                            _c.trys.push([7, 10, , 16]);
                            _b = (_a = authorizer).storageSession;
                            return [4 /*yield*/, authorizer.refreshSession(session)];
                        case 8: return [4 /*yield*/, _b.apply(_a, [_c.sent()])];
                        case 9:
                            _c.sent();
                            return [3 /*break*/, 16];
                        case 10:
                        ...
                        case 11:
                            ...
                            return [4 /*yield*/, authorizer.onAuthorizedDenied(e2_1)];
                        case 12:
                            _c.sent();
                            authorizer.sessionHistory.clean();
                            return [3 /*break*/, 15];
                        ...
                        case 17:
                            ...
                            return [4 /*yield*/, queue.resend(e)];
                        case 18: return [2 /*return*/, _c.sent()];
                        case 19:
                            e4_1 = _c.sent();
                            throw e4_1;
                        case 20: return [3 /*break*/, 23];
                        case 21: return [4 /*yield*/, queue.push(e)];
        ...
        config.axios.interceptors.request.use(function (request) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, authorizer.getSession()];
                        case 1:
                            session = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (window && window.sessionStorage) {
                    ...
                    return [2 /*return*/, value ? JSON.parse(value) : value];
                }
                else if (wx && wx.getStorageSync) {
                    return [2 /*return*/, wx.getStorageSync(key)];
                }
                else if (my && my.getStorageSync) {
                    return [2 /*return*/, my.getStorageSync(key)];
                }
                else if (tt && tt.getStorageSync) {
                    return [2 /*return*/, tt.getStorageSync(key)];
                }
                else {
                    return [2 /*return*/, this._inMemoryStorage[key]];
                }
            });
        });
    };
...
var SessionHistory = /** @class */ (function () {
    ...
    SessionHistory.prototype.add = function (session) {
        if (Object.keys(session).every(function (i) { return isNullOrEmpty(session[i]); })) {
            return;
        }
        ...
        this._size = this._history.reduce(function (s, i) { return i ? s + 1 : s; }, 0);
    };
...
var Authorizer = /** @class */ (function () {
    ...
    Authorizer.prototype.getSession = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sessionStorage.get(this.sessionKey)];
    ...
    Authorizer.prototype.storageSession = function (session) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sessionStorage.set(this.sessionKey, session)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Authorizer.prototype.checkResponse = function (response) {
        var status = (response || { status: 0 }).status;
        return status !== 401;
    };
    ...
    Authorizer.prototype.invalidateSession = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sessionStorage.remove(this.sessionKey)];
                    case 1:
                        _a.sent();
